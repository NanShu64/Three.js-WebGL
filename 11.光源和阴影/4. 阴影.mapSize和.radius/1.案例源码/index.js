...
// console.log("阴影修改后像素", directionalLight.shadow.mapSize);


// 模糊弱化阴影边缘
console.log(".shadow.radius默认", directionalLight.shadow.radius);
directionalLight.shadow.radius = 3;
console.log(".shadow.radius修改后", directionalLight.shadow.radius);
